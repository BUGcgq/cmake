...
enum OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_E {
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_CONNECTOR_LOCK_FAILURE = 0,    // 充电枪锁定失败
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_EV_COMMUNICATION_ERROR,        // 电动汽车通信错误
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_GROUND_FAILURE,                // 地线故障
    ...
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_OVERCURRENT_FAILURE,           // 过流故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_OVERVOLTAGE,                   // 过电压故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_POWERMETER_FAILURE,            // 电力仪表故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_POWERSWITCH_FAILURE,           // 电源开关故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_READER_FAILURE,                // 读卡器故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_RESET_FAILURE,                 // 复位失败
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_UNDERVOLTAGE,                  // 欠电压故障
    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_WEAKSIGNAL,                    // 信号弱

    OCPP_PACKAGE_CHARGEPOINT_ERRORCODE_MAX                            // 充电桩错误代码的数量，方便循环遍历或判断范围
};
